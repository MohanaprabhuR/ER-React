                ...
                <div className="flex items-center gap-3 pt-10 max-sm:pt-6">
                  ...
                  {testimonial.testimonialRole && (
                    <div className="flex flex-col">
                      <p className="text-ellipsis font-sans text-base not-italic leading-[138%] tracking-[0.192px] text-[#211F28] font-wght-600 max-sm:text-[15px] max-sm:leading-[138%]">
                        {testimonial.testimonialName}
                      </p>

                      <p className="font-sans text-sm not-italic leading-[131%] tracking-[0.196px] text-[#545A69] font-wght-450 max-sm:text-[13px] max-sm:leading-[131%]">
                        {testimonial.testimonialRole}
                      </p>
                    </div>
                  )}
